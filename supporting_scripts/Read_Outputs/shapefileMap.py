...
# Shapefile River
shpfile_subdir = 'shapefile/shapefiles/'
shpfile_file = 'Flowline_CO_14_cameo.shp'
shpfile_fullpath = mainModelDir + shpfile_subdir + shpfile_file
...
# Openwq h5 results
openwq_out_dir = 'Output_OpenWQ/HDF5/'
openwq_out_file = 'RIVER_NETWORK_REACHES@SPECIES_A#G-main.h5'
hf_file = h5py.File(mainModelDir + openwq_out_dir + openwq_out_file, 'r')
...
# mizuroute results
mizuroute_out_dir = 'output/'
mizuroute_out_fileame = 'v1.2_case1.h.1950-01-01-43200.nc' # just a sample for now
mizuroute_out_file = netCDF4.Dataset(mainModelDir + mizuroute_out_dir + mizuroute_out_fileame)
