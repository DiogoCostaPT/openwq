...
BGC_JSON_dict["CHEMICAL_SPECIES"]["MOBILE_SPECIES"] = vector_mobile
...
for i in range(0, len(node_ids)):
    BGC_JSON_dict["CHEMICAL_SPECIES"]["LIST"][str(i + 1)] = node_labels[i]

##############################
# Construct cycling frameworks dictionary
BGC_JSON_dict["CYCLING_FRAMEWORKS"][CYCLING_FRAMEWORKS_name] = {}

# Add list of transformations and details for each of them
BGC_JSON_dict["CYCLING_FRAMEWORKS"][CYCLING_FRAMEWORKS_name]["LIST_TRANSFORMATIONS"] = {}

for i in range(0, len(arrow_ids)):

    # Add to list of transformations
    BGC_JSON_dict["CYCLING_FRAMEWORKS"][CYCLING_FRAMEWORKS_name]["LIST_TRANSFORMATIONS"][str(i + 1)] = arrow_labels[i]

    # Add details of transformation
    BGC_JSON_dict["CYCLING_FRAMEWORKS"][CYCLING_FRAMEWORKS_name][str(i + 1)] = {}
    BGC_JSON_dict["CYCLING_FRAMEWORKS"][CYCLING_FRAMEWORKS_name][str(i + 1)]["CONSUMED"] = \
        node_labels[node_ids.index(arrow_sources[i])]
    BGC_JSON_dict["CYCLING_FRAMEWORKS"][CYCLING_FRAMEWORKS_name][str(i + 1)]["PRODUCED"] = \
        node_labels[node_ids.index(arrow_targets[i])]
    BGC_JSON_dict["CYCLING_FRAMEWORKS"][CYCLING_FRAMEWORKS_name][str(i + 1)]["KINETICS"] = \
        arrow_kinetics[i]
    BGC_JSON_dict["CYCLING_FRAMEWORKS"][CYCLING_FRAMEWORKS_name][str(i + 1)]["PARAMETER_NAMES"] = []
    BGC_JSON_dict["CYCLING_FRAMEWORKS"][CYCLING_FRAMEWORKS_name][str(i + 1)]["PARAMETER_VALUES"] = {}
